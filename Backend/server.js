...
try {
  ...
  supporterRoutes   = require('./routes/supporterRoutes');
  surveyRoutes      = require('./routes/surveyRoutes');
  campaignPlanRoutes = require('./routes/campaignPlanRoutes');
...
app.use('/api/campaign-plan', campaignPlanRoutes);
